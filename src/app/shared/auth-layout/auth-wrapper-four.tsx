...
import Link from '@/lib/browser/link';
import Image from '@/lib/browser/image';
import { usePathname } from '@/lib/browser/navigation';
        ...
        >
          ...
          {isSocialLoginActive && (
            <>
              ...
              <OrSeparation
                title={`or, ${isSignIn ? 'sign in' : 'sign up'} with your email`}
                isCenter
  ...
  return (
    <footer className="flex flex-col-reverse items-center justify-between px-4 py-5 lg:flex-row lg:px-16 lg:py-6 2xl:px-24 2xl:py-10">
      <div className="text-center leading-relaxed text-gray-500 lg:text-start">
        Copyright RedQ, all rights reserved
      </div>
